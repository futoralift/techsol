  ...
  return (
    <>
      ...
      >
        ...
        <motion.div
          variants={fadeInUp}
          className="max-w-[1000px] mx-auto mt-16 pt-6 border-t border-[#E5E3E1] flex flex-col sm:flex-row items-center justify-between text-[14px] font-semibold text-[#555555]"
        >
